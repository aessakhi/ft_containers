...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/17 19:53:03 by aessakhi          #+#    #+#             */
/*   Updated: 2023/01/17 19:56:06 by aessakhi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	for (size_t i = 0; i < n_of_insert; i++)
		set_test.insert(i);
	std::cout << "Time to insert 5000000 int: " << get_relative_ms(before) << " ms" << std::endl;
	
	gettimeofday(&before, NULL);
	set_test.clear();
	std::cout << "Time clear 5000000 int: " << get_relative_ms(before) << " ms" << std::endl;
}
