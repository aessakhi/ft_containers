...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/18 22:04:38 by aessakhi          #+#    #+#             */
/*   Updated: 2022/12/18 22:29:02 by aessakhi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_reverse_iterator(void) {
  ...
  std::cout << *ft_rev_from << std::endl;
  std::cout << *ft_rev_until << std::endl;

  std::reverse_iterator< iter_type > std_rev_from(until);
  std::reverse_iterator< iter_type > std_rev_until(from);
  std::cout << *std_rev_from << std::endl;
  std::cout << *std_rev_until << std::endl;
